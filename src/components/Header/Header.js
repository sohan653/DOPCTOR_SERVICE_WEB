    ...
    return (
        ...
        <div className='relative'>
          ...
          <button onClick={()=>navigate('/')} className=' justify-center    lg:w-1/3 text-white flex items-center text-2xl'>
              ...
              <ul className={`md:flex font-bold  w-full justify-end z-20 items-center absolute md:static ${open ? 'top-6': 'top-[-120px]'}`}>
            ...
            {user && <>
                <CustomLink className='mr-2 p-3' to='/add'> Add Service</CustomLink>
                <CustomLink className='mr-2 p-3' to='/manage'>Manage</CustomLink>
            </>}
